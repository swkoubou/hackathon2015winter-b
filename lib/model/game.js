...
Games.method('swapBlocks', function (userId, block1, block2, callback) {
    var game = this;

    var user = _.find(this.users, function (user) { return String(user.user) === userId; });
    ...
    var idx1 = block1.y * game.stageWidth + block1.x;
    var idx2 = block2.y * game.stageWidth + block2.x;

    Block.swap(user.blocks[idx1], user.blocks[idx2]);
